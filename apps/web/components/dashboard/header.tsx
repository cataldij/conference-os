  ...
  return (
    <header className="flex h-20 items-center justify-between border-b border-white/70 bg-white/75 px-8 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-4">
        <Button className="hidden items-center gap-2 rounded-full bg-slate-900 px-4 text-white shadow-soft transition hover:bg-slate-800 md:flex">
          <Plus className="h-4 w-4" />
          New conference
        </Button>
        <Button variant="outline" size="icon" className="relative border-white/70 bg-white/80">
